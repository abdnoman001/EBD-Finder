      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl px-2">
        {finders.map((finder) => (
          <Link href={finder.href} key={finder.name} className="group">
            <div className="glass-card h-full flex flex-col rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 bg-white/60">
