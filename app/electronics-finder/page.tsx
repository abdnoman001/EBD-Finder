...
export default function Page() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-gradient-to-br from-purple-100 via-indigo-100 to-blue-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 transition-colors duration-300">
            <div className="glass-card p-12 rounded-2xl max-w-lg w-full text-center shadow-xl dark:bg-gray-800/60 dark:border-gray-700">
                <h1 className="text-5xl font-bold mb-6 text-gray-800 dark:text-white drop-shadow-sm">Electronics Finder</h1>
